...
describe("parse", () => {
  ...
  it("parse with old Jed format", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/pl-jedold.json",
        "utf-8",
      ),
    );
  ...
  it("parse with current Jed format", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/pl-jed.json",
        "utf-8",
      ),
    );
  ...
  it("parse with MessageFormatter format", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/pl-mf.json",
        "utf-8",
      ),
    );
  ...
  it("parse with MessageFormatter and compile successfully", () => {
    ...
    assert.equal(
      messages['A sentence with "quotation" marks.']({}),
    ...
    assert.equal(
      messages["string context"]["the contextual phrase"]({}),
      "zwrot kontekstowe",
    );
  });
  ...
  it("parse with full MessageFormatter format", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/pl-mf-full.json",
        "utf-8",
      ),
    );
  ...
  it("parse with MessageFormatter format + fallback-to-msgid", () => {
    const po = readFileSync(
      import.meta.dirname + "/../test/fixtures/en-empty.po",
    );
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/en-mf-fallback-to-msgid.json",
        "utf-8",
      ),
    );
  ...
  it("parse with fallback-to-msgid", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/en-empty.json",
        "utf-8",
      ),
    );
  ...
  it("parse with Plural-Forms == nplurals=1; plural=0;", () => {
    ...
    const json = JSON.parse(
      readFileSync(import.meta.dirname + "/../test/fixtures/ja.json", "utf-8"),
    );
    const parsed = po2json.parse(po);
    assert.deepStrictEqual(parsed, json);
  });
  ...
  it("parse with Plural-Forms == nplurals=1; plural=0; and with the current Jed format", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/ja-jed.json",
        "utf-8",
      ),
    );
    const parsed = po2json.parse(po, { format: "jed" });
  ...
  it("parse with no headers", () => {
    const po = readFileSync(
      import.meta.dirname + "/../test/fixtures/en-no-header.po",
    );
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/en-no-header.json",
        "utf-8",
      ),
    );
    const parsed = po2json.parse(po);
  ...
  it("parse with raw JSON context correctly", () => {
    const po = readFileSync(
      import.meta.dirname + "/../test/fixtures/es-context.po",
    );
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/es-context.json",
        "utf-8",
      ),
    );
  ...
  it("parse with jed < 1.1.0 context correctly", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/es-context-jedold.json",
        "utf-8",
      ),
    );
    const parsed = po2json.parse(po, { format: "jedold" });
  ...
  it("parse with jed >= 1.1.0 context correctly", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/es-context-jed.json",
        "utf-8",
      ),
    );
    const parsed = po2json.parse(po, { format: "jed" });
  ...
  it("parse with MessageFormat context correctly", () => {
    ...
    const json = JSON.parse(
      readFileSync(
        import.meta.dirname + "/../test/fixtures/es-context-mf.json",
        "utf-8",
      ),
    );
    const parsed = po2json.parse(po, { format: "mf" });
